/**
 * Consolidate ONWSIB Classified Batch
 * 
 * Merges classified ONWSIB batch into master file and updates progress.
 * 
 * Usage: node scripts/consolidate-onwsib-batch.mjs
 */
...
const MASTER_FILE = path.join(__dirname, '..', 'data/comprehensive-extraction/onwsib-classified.json');
...
function loadMaster() {
  ...
  return {
    metadata: {
      tribunal: 'ONWSIB',
      fullName: 'Ontario Workplace Safety and Insurance Board - Internal Review',
      totalDecisions: 0,
