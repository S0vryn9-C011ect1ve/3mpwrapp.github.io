...
try {
    wrangler pages deploy _site --project-name=3mpwrapp --branch=main --commit-dirty=true
    Write-Host ""
...
Write-Host "Check deployment at https://3mpwrapp.pages.dev" -ForegroundColor Gray
Write-Host ""
