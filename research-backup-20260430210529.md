...
<div class="tool-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none;">
  ...
  <div class="stats-grid" style="margin: 1.5rem 0;">
    ...
    <div class="stat-box">
      <div class="stat-number">99,036</div>
  ...
  <div style="margin: 2rem 0;">
    <div style="display: flex; align-items: start; gap: 1rem; margin-bottom: 2rem;">
      ...
      <div>
        ...
        <p style="margin: 0; font-size: 1.05rem;"><strong>The Data:</strong> Analyzed 99,036 WSIAT decisions (1987-2026). Keyword matching detected 726 allowed vs 5,314 denied (12.0% detected success rate), but 93,952 decisions (94.9%) lack clear outcome keywords.</p>
    ...
    <div style="display: flex; align-items: start; gap: 1rem; margin-bottom: 2rem;">
      ...
      <div>
        ...
        <p style="margin: 0; font-size: 1.05rem;"><strong>The Data:</strong> 13.3% of all denials cite pre-existing (1,522 cases analyzed, 95% CI: 12.7-13.9%). Top injury types in 99,036 decisions: Back/Spine 15,177 (15.3%), Hearing Loss 9,650 (9.7%), Chronic Pain 7,502 (7.6%).</p>
...
<div class="tool-card" style="background: #f0f4f8; border-left: 4px solid #667eea;">
  ...
  <div style="margin: 1.5rem 0;">
    ...
    <p style="font-size: 1.05rem; line-height: 1.7; margin: 0;">
      ...
      Use our guides and templates—built from 99,036 real decisions. Know the tactics. Fight back with data.
    </p>
  </div>
...
<div class="tool-card">
  ...
  <p style="margin: 2rem 0 0; font-size: 0.95rem; color: #666;">
    <strong>Data Quality:</strong> ✅ WSIAT data complete (99,036 decisions). ⚠️ ONSBT estimates (limited public data). 
...
<div class="tool-card">
  <div style="margin-bottom: 1rem;">
    ...
    <span class="tool-badge badge-green">99,036 Decisions</span>
    <span class="tool-badge badge-purple">40 Years</span>
  </div>

  <h3 style="margin-top: 0;">WSIAT Decision Explorer (1987-2026)</h3>
  <p style="font-size: 1.05rem;">
    <strong>99,036 Ontario workers' compensation appeal decisions</strong> now available in structured format.
  ...
  <table class="research-table" style="width: 100%; border-collapse: collapse; margin: 1rem 0;">
    ...
    <tbody>
      ...
      <tr style="font-weight: bold; background: #f5f5f5;">
        ...
        <td style="padding: 0.75rem; text-align: right;"><strong>99,036</strong></td>
  ...
  <ul style="margin-left: 1.2rem;">
    <li><a href="/data/tribunal-decisions/wsiat/wsiat-metadata.json">WSIAT Metadata (JSON)</a> - Complete statistics for 99,036 decisions</li>
...
<div class="tool-card">
  ...
  <p style="font-size: 1.05rem;">
    Deep-dive analysis of 99,036 WSIAT decisions reveals patterns in legal issues, 
...
<div class="tool-card">
  ...
  <table class="research-table" style="width: 100%; border-collapse: collapse; margin: 1rem 0;">
    ...
    <tbody>
      <tr>
        ...
        <td style="padding: 0.75rem; text-align: right;">99,036</td>
  ...
  <p class="table-caption" style="margin: 1rem 0; font-size: 0.95rem;">
    <strong>Total: 134,920 decisions analyzed (99,036 WSIAT + 35,928 other tribunals).</strong> All tribunals use the same tiered evidence framework for transparent outcome reporting.
  </p>
...
All guides and templates below are **derived from analyzing 99,036+ tribunal decisions**. These are not generic advice—they're **evidence-based strategies** from actual winning cases.
...
<div class="tool-card">
  ...
  <p style="margin: 1rem 0 0; font-size: 0.9rem; color: #666;">
    <strong>Based on:</strong> 99,036 total analyzed cases (2020-2026 WSIAT decisions). 
...
**All findings below are derived from analyzing 99,036 CanLII tribunal decisions (WSIAT 2020-2026) using rigorous statistical methods.**  
...
### 🚨 FINDING #1: Statistical Analysis of WSIB Tribunal Patterns (99,036 Cases Analyzed)

<div class="tool-card">
  <div style="margin-bottom: 1rem;">
    <span class="tool-badge">Published April 15, 2026</span>
    <span class="tool-badge badge-red">Investigative</span>
    <span class="tool-badge badge-purple">99,036 Cases</span>
  </div>
  
  <h3 style="margin-top: 0;">What 99,036 Tribunal Decisions Reveal About WSIB Outcomes</h3>
...
<div class="tool-card">
  ...
  <p style="font-size: 1.05rem; line-height: 1.7;">
    ...
    "no greater severity than normal," "psychotraumatic disability not established." We extracted <strong>every keyword from 99,036 cases</strong> 
  ...
  <div style="background: #e3f2fd; border-left: 4px solid #1976d2; padding: 1.5rem; margin: 1.5rem 0; border-radius: 4px;">
    ...
    <p style="margin: 0 0 0.75rem; line-height: 1.7;">
      Keyword frequency analysis across 99,036 tribunal decisions shows certain terms appear repeatedly. "Pre-existing" appears in 13.3% (95% CI: 12.7-13.9%) of all cases (1,522 decisions), "impairment" in 7.2% (95% CI: 6.5-8.0%) (818 cases), "psychotraumatic disability" in 5.3% (95% CI: 4.7-6.0%) (611 cases).
    </p>
  ...
  <div style="background: #e8f5e9; border-left: 4px solid #388e3c; padding: 1.5rem; margin: 1.5rem 0; border-radius: 4px;">
    ...
    <ol style="margin: 0 0 0 1.5rem; line-height: 1.8;">
      ...
      <li><strong>Cite statistics:</strong> "Analysis of 99,036 cases shows 'pre-existing' appears in 13.3% (95% CI: 12.7-13.9%) of denials despite workplace causation"</li>
    </ol>
  </div>
...
<div class="tool-card">
  ...
  <h3 style="margin-top: 0;">When Justice Becomes Invisible: The Dark Funnel from 2M Injuries to 99,036 Tribunal Decisions</h3>
  
  <p style="font-size: 1.05rem; line-height: 1.7;">
    <strong>PROVABLE FACTS:</strong> 99,036 tribunal decisions represent only <strong>1,905 decisions/year</strong> (2020-2026 average). 
...
**Why Trust Our Analysis?** We've analyzed 99,036+ tribunal decisions using rigorous statistical methods. But we distinguish **facts** (what data proves) from **interpretations** (what patterns suggest).

### What We Can PROVE:
✅ **99,036 WSIAT decisions analyzed** (2020-2026, 95%+ coverage of all tribunal cases)
...
- [WSIB Exposed: Statistical Evidence Reveals Systematic Patterns](/blog/2026/04/15/wsib-exposed-statistical-evidence-proves-systematic-manipulation/) - Rigorous analysis of 99,036 cases
