...
**📊 91.8% of tribunal decisions have no public outcome data** — We can't tell if workers won or lost in 10,491 of 99,036 cases analyzed (2020-2026)
...
**What we analyzed:**
- **99,036 WSIAT tribunal decisions** (2020-2026) from CanLII
...
**Direct measurements** — Numbers we counted from tribunal decisions (e.g., "99,036 cases" or "91.8% have no outcome data"). These come directly from CanLII's database of published decisions.
...
Imagine a massive funnel. At the top: **every workplace injury in Ontario (2020-2026)**. At the bottom: the 99,036 tribunal decisions we analyzed.
...
- **📊 MEASURED tribunal volume:** 99,036 cases over 6 years = **1,905/year average (provable)**
...
**⚠️ CRITICAL CAVEAT:** The 1.14-2.29M estimate is extrapolated from peer-reviewed IWH research applied to Ontario's workforce. The tribunal volume (99,036) is directly measured. If the extrapolation is materially off, the estimate range would shift accordingly.
...
Of 99,036 tribunal decisions analyzed:
...
| Outcome Category | Count | % of 939 | % of Total 99,036 | What It Means |
|-----------------|-------|----------|-------------------|---------------|
...
Only 93 of 99,036 cases (0.8%) show clear worker victories in CanLII metadata. This doesn't mean workers only win 0.8% of the time—it means CanLII's keyword/API data for WSIAT decisions often lacks explicit outcome labels.
...
- 📊 Reached tribunal (MEASURED): 99,036
...
- 📊 **MEASURED:** 99,036 tribunal cases (provable from CanLII)
...
5. **Adjudicator Consistency Analysis**
   - Analyze all 99,036 decisions by adjudicator name
...
**WHAT WE CAN PROVE DIRECTLY (from our 99,036-case analysis):**
...
- [WSIB Statistical Pattern Analysis](https://3mpwrapp.ca/blog/2026/04/15/wsib-exposed-statistical-evidence-proves-systematic-manipulation/) - Pattern findings from 99,036 cases
...
1. **Your decision missing from CanLII after 6+ months**
   - ➡️ **Data shows:** In CanLII keyword/API data, 91.8% of decisions have no explicit outcome-labeled keyword (10,491 of 99,036 decisions)
